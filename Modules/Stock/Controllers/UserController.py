...
def get_all_categories_controller(
    ...
    return success_response(message="Categories fetched successfully", 
    data=[to_category_dict(category) for category in categories], status_code=200,
    )
...
def get_category_by_id_controller(
    ...
    return success_response(message="Category fetched successfully", 
    data=to_category_dict(category), status_code=200,
    )
