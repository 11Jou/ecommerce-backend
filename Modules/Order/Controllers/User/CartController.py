...
async def add_item_to_cart(
    ...
    await cart_service.create_cart_item(cart_item, cart.id)
...
async def update_cart_item(
    ...
    await cart_service.update_item_quantity(
        ...
        quantity=update_cart_item_schema.quantity,
    )
    updated_cart = await cart_service.get_cart_by_id(cart.id)
    return success_response(
...
async def delete_cart_item(
    ...
    updated_cart = await cart_service.get_cart_by_user_id(current_user.id)
    return success_response(
